      ...
      <section className="px-5 py-10 lg:px-7">
        <div className="mx-auto max-w-[1040px] text-center">
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-[var(--ai-border)] bg-[rgba(11,23,42,0.72)] p-1.5">
            ...
            <span className="rounded-full bg-[rgba(0,153,255,0.12)] px-3 py-2 text-xs font-semibold text-[var(--ai-cyan)]">
          ...
          {plans.map((plan) => (
            <article
              ...
              className={`relative rounded-[24px] border p-6 ${
                plan.featured
                  ? "border-[rgba(28,101,255,0.62)] bg-[linear-gradient(180deg,rgba(15,38,79,0.95),rgba(10,21,41,0.98))] shadow-[0_18px_50px_rgba(28,101,255,0.24)]"
                  : "border-[var(--ai-border)] bg-[linear-gradient(180deg,rgba(11,23,42,0.98),rgba(8,17,31,0.98))]"
              }`}
            >
              {plan.featured ? (
                <span className="absolute -top-3 left-6 rounded-full bg-[linear-gradient(135deg,#1243d6_0%,#1c65ff_100%)] px-3 py-1 text-xs font-semibold text-white">
                  Most Popular
                </span>
              ) : null}
              ...
              <ul className="mt-6 space-y-3 text-sm text-[var(--ai-text-secondary)]">
                {plan.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[rgba(0,153,255,0.12)] text-[var(--ai-cyan)]">
